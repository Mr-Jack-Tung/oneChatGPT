...
'''
% uv run Single_Block_GPT2_0,8k_params_OMG/inference_single_block_gpt2.py
Character tokenizer loaded from TrainedSingleBlockGPT2_0,8k_params
Trained model state dictionary loaded from TrainedSingleBlockGPT2_0,8k_params/single_block_model_state_dict.pth
