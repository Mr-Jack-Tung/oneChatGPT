...
class GPT2Config:
    ...
    def __init__(self, model_type="small", vocab_size=None):
        ...
        if model_type == "small":
            ...
            self.n_head = 12
            self.embd_pdrop = 0.1 # Standard dropout rate
            self.attn_pdrop = 0.1 # Standard dropout rate
            self.resid_pdrop = 0.1 # Standard dropout rate
        ...
        # Vocab size will be determined by the transformers tokenizer
...
class SingleBlockGPT2Model(nn.Module): # Renamed from SingleBlockGPT2ModelNoDepend
    def __init__(self, config):
        super().__init__()
        self.config = config
