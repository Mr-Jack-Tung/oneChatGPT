...
Character tokenizer loaded from TrainedSingleBlockGPT2_No_depend
Trained model state dictionary loaded from TrainedSingleBlockGPT2_No_depend/single_block_model_state_dict.pth
