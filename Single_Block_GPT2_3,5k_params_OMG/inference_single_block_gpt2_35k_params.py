...
'''
% uv run Single_Block_GPT2_3,5k_params_OMG/inference_single_block_gpt2_35k_params.py
Character tokenizer loaded from TrainedSingleBlockGPT2_3,5k_params
Trained model state dictionary loaded from TrainedSingleBlockGPT2_3,5k_params/single_block_model_state_dict.pth
